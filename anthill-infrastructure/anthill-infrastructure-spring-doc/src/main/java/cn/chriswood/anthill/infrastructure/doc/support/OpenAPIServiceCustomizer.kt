...
class OpenAPIServiceCustomizer(
    ...
    override fun buildTags(
        ...
        if (!CollectionUtils.isEmpty(tagsStr)) {
            if (CollectionUtils.isEmpty(operation.tags)) operation.tags = ArrayList(tagsStr) else {
                val operationTagsSet: MutableSet<String?> = HashSet(
                    operation.tags
                )
            ...
            if (javadocProvider!!.isPresent) {
                ...
                if (StringUtils.isNotBlank(description)) {
                    ...
                    val list: List<String> =
                        IoUtil.readLines<ArrayList<String>>(StringReader(description), ArrayList<String>())
